...
local function updateDisplay()
  if obj.startTime then
    ...
    obj.display:setTitle(timeFormat(timeRemaining))
...
function obj:toggleOff()
  ...
  self.display:setTitle(timeFormat(self.duration))
end
...
function obj:init()
  self:toggleOff()
  self.display:setClickCallback(function() self:toggle() end)
